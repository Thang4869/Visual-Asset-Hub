        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: true),
                    ThumbnailSm = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ThumbnailMd = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ThumbnailLg = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    HexCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionPermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_Collection_ParentFolder",
                table: "Assets",
                columns: new[] { "CollectionId", "ParentFolderId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionPermissions_User_Collection",
                table: "CollectionPermissions",
                columns: new[] { "UserId", "CollectionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Collections_Order",
                table: "Collections",
                column: "Order");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_NormalizedName_UserId",
                table: "Tags",
